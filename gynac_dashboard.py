...
def main():
    ...
    medical_file = 'data\Gynac.xlsx'
    st.set_page_config(layout="wide", page_title="Gynac Dashboard")
    ...
    title_placeholder.title("Gynac Dashboard")
    ...
    title_placeholder.title(f"Gynac Dashboard From: {start_date.strftime('%d-%m-%Y')} to {end_date.strftime('%d-%m-%Y')}")
