...
def main():
    ...
    medical_file = 'data\DERMA-Digitised Dataset.xlsx'
    st.set_page_config(layout="wide", page_title="Dermat Dashboard")
    ...
    title_placeholder.title("Dermat Dashboard")
    ...
    title_placeholder.title(f"Dermat Dashboard From: {start_date.strftime('%d-%m-%Y')} to {end_date.strftime('%d-%m-%Y')}")
